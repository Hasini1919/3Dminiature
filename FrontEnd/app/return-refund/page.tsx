          ...
          {activeSection === "returns-refunds" && (
            <section id="returns-refunds" className="bg-white rounded-md shadow p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                We value our customers and want you to be satisfied with your 3D miniature frame purchase.
                Please read our return and refund policy carefully to understand your rights.
              </p>
            </section>
          )}
          ...
          {activeSection === "refunds-policy" && (
            <section id="refunds-policy" className="bg-white rounded-md shadow p-6">
              ...
              <p className="mb-3 text-gray-700 leading-relaxed">
                Once your 3D miniature frame return is received and inspected, we will notify you of the
