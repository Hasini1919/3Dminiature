  ...
  return (
    <div className=" container mx-auto flex flex-col lg:flex-row items-start justify-center gap-8 p-6">
      ...
      <div className="bg-gray-100 p-4 rounded-lg shadow-md">
        ...
        <div className="bg-gray-100 p-4 rounded-lg shadow-md">
          <h5 className="text-lg font-semibold flex items-center gap-2"> <Image src="/email.svg" alt="Phone" width={30} height={30} />
          Write to Us</h5>
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-lg mx-auto space-y-4">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              value={inputs.phone ?? ""}
              id="phone"
              className={`border rounded px-3 py-2 w-full bg-gray-100  ${errors.phone ? 'border-red-500' : ''}`}
            />
